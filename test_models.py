"""
Test script to verify both LSTM and Decision Tree models are working
"""
import sys
import os
...
def test_models():
    print("Testing Hybrid Fraud Detection Models...")
    print("=" * 50)
    ...
    try:
        ...
        print(f"Decision Tree probabilities: {dt_probs}")
    ...
    try:
        ...
        print(f"LSTM probabilities: {lstm_probs}")
    except Exception as e:
